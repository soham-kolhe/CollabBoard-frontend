        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-20 h-7 text-red-500 border border-slate-500 hover:text-red-500 text-sm rounded-md hover:bg-slate-100 transition-all"
            >
              Sign out
            </button>
          </div>
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-1">
              You have {boards.length} board{boards.length !== 1 ? "s" : ""} in
              your workspace.
            </p>
          </div>
          <div className="flex items-center gap-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                  {boards
                    ...
                    .map((board) => (
                      <div
                        key={board._id}
                        className="group bg-white hover:bg-slate-200 border border-slate-800 rounded-2xl p-5 cursor-pointer transition-all duration-300 hover:shadow-2xl hover:shadow-slate-300/50 hover:-translate-y-1"
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            <h3 className="text-black font-semibold truncate text-lg tracking-tight">
                              {board.name}
                            </h3>
                          ...
                          <div className="flex items-center gap-1 ml-2">
                            <button
                              ...
                              title="Copy Room ID"
                              className="p-1.5 text-black hover:text-slate-700 hover:bg-white/10 rounded-lg transition-all opacity-0 group-hover:opacity-100"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="none"
                            ...
                            <button
                              ...
                              title="Delete board"
                              className="p-1.5 text-black hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-all opacity-0 group-hover:opacity-100 disabled:opacity-50"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="none"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                  {boards
                    ...
                    .map((board) => (
                      <div
                        key={board._id}
                        className="group bg-slate-50 hover:bg-slate-200 border border-slate-800 rounded-2xl p-5 cursor-pointer transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/10 hover:-translate-y-1 relative overflow-hidden"
                        onClick={() => navigate(`/board/${board.boardId}`)}
                      >
                        ...
                        <div className="h-24 rounded-xl bg-black border border-slate-200/60 mb-4 flex items-center justify-center overflow-hidden">
                          <svg
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            <h3 className="text-slate-900 font-bold truncate tracking-tight" title={`${board.adminName || 'Admin'} - ${board.name}`}>
                              {board.name} by {board.adminName || 'Admin'}
                            </h3>
